...
results_training_and_testing_percent_accuracy <- data_processed %>% 
...
results_training_and_testing_percent_pass <- data_processed %>% 
  select(unique_id, experiment, 
...
- possibly reorder the cols in the processing
- separate data read from exclusions, run demographics on full data
