...
forest(fit_basic_effect_oec_sensitivity, 
       ...
       xlim = c(-2.5, 6),
       at = c(-1, 0, 1, 2, 3, 4))
text(-2.5, 23, "Basic OEC effect (Pass Group)", pos = 4)
text(6, 23, substitute(paste(italic('d'), " [95% CI]")), pos = 2)
...
forest(fit_moderation_by_extinction_ir_sensitivity, 
       ...
       xlim = c(-1.75, 2),
       at = c(-1, -0.5, 0, 0.5, 1))
text(-1.75, 17, "Moderation of IR effect by extinction (Pass Group)", pos = 4)
text(2, 17, substitute(paste(italic('d'), " [95% CI]")), pos = 2)
...
text(-1.75, 12, "Moderation of OEC effect by extinction (Pass Group)", pos = 4)
text(2, 12, substitute(paste(italic('d'), " [95% CI]")), pos = 2)
...
forest(fit_moderation_by_counterconditioning_ir_sensitivity, 
       ...
       xlim = c(-2.25, 2),
       at = c(-1.5, -1, -0.5, 0, 0.5, 1))
text(-2.25, 11, "Moderation of IR effect by counterconditioning (Pass Group)", pos = 4)
text(2, 11, substitute(paste(italic('d'), " [95% CI]")), pos = 2)
...
forest(fit_moderation_by_counterconditioning_oec_sensitivity, 
       ...
       refline = 0,
       xlim = c(-3.25, 2.75),
       at = c(-2.0, -1.5, -1, -0.5, 0, 0.5, 1, 1.5))
text(-3.3, 8, "Moderation of OEC effect by counterconditioning (Pass Group)", pos = 4)
text(2.75, 8, substitute(paste(italic('d'), " [95% CI]")), pos = 2)
