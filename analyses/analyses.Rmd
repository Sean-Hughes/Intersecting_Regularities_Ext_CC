...
### Behavioral Intentions OEC 

```{r}

data_reshaped_intentions_acquisition_oec <- data_processed_after_exclusions %>%
  filter(experiment_condition == c("acquisition_only") &
           behavioral_intentions_OEC %in% c("brand_A", "brand_B")) %>%
...
temp_study_1 <- data_reshaped_intentions_acquisition_oec %>%
  filter(experiment == 1) %>%
  select(brand_A, brand_B) %>%
  as.matrix() %>%
  epitools::epitab(x = .)

temp_study_2 <- data_reshaped_intentions_acquisition_oec %>%
  filter(experiment == 2) %>%
  select(brand_A, brand_B) %>%
  as.matrix() %>%
  epitools::epitab(x = .)

temp_study_3 <- data_reshaped_intentions_acquisition_oec %>%
  filter(experiment == 3) %>%
  select(brand_A, brand_B) %>%
  as.matrix() %>%
  epitools::epitab(x = .)

temp_study_4 <- data_reshaped_intentions_acquisition_oec %>%
  filter(experiment == 4) %>%
  select(brand_A, brand_B) %>%
  as.matrix() %>%
  epitools::epitab(x = .)

temp_study_5 <- data_reshaped_intentions_acquisition_oec %>%
  filter(experiment == 5) %>%
  select(brand_A, brand_B) %>%
  as.matrix() %>%
  epitools::epitab(x = .)

temp_study_6 <- data_reshaped_intentions_acquisition_oec %>%
  filter(experiment == 6) %>%
  select(brand_A, brand_B) %>%
  as.matrix() %>%
  epitools::epitab(x = .)

temp_study_7 <- data_reshaped_intentions_acquisition_oec %>%
  filter(experiment == 7) %>%
  select(brand_A, brand_B) %>%
  as.matrix() %>%
  epitools::epitab(x = .)

results_basic_effect_intentions_oec <-
  bind_rows(
    as.data.frame(temp_study_1$tab) %>%
      drop_na() %>%
      select(OR = oddsratio, OR_ci_lower = lower, OR_ci_upper = upper, p = p.value) %>%
...
write_csv(results_basic_effect_intentions_oec, "results/results_basic_effect_intentions_oec.csv")
...
## Were evaluative learning effects moderated by extinction?
...
data_reshaped_intentions_moderation_by_extinction_oec <- data_processed_after_exclusions %>%
  filter(experiment_condition %in% c("acquisition_only", "acquisition_and_extinction") &
           experiment %in% c(1, 2, 3, 4, 7) &
           behavioral_intentions_OEC %in% c("brand_A", "brand_B")) %>%
  count(experiment, experiment_condition, behavioral_intentions_OEC) %>%
  spread(behavioral_intentions_OEC, n) %>%
  # Haldane-Anscombe correction
  group_by(experiment) %>%
  mutate(count_zero = as.logical(max(c(is.na(brand_A), is.na(brand_B))))) %>%
...
temp_study_1 <- data_reshaped_intentions_moderation_by_extinction_oec %>%
  filter(experiment == 1) %>%
  select(brand_A, brand_B) %>%
  as.matrix() %>%
  epitools::epitab(x = .)

temp_study_2 <- data_reshaped_intentions_moderation_by_extinction_oec %>%
  filter(experiment == 2) %>%
  select(brand_A, brand_B) %>%
  as.matrix() %>%
  epitools::epitab(x = .)

temp_study_3 <- data_reshaped_intentions_moderation_by_extinction_oec %>%
  filter(experiment == 3) %>%
  select(brand_A, brand_B) %>%
  as.matrix() %>%
  epitools::epitab(x = .)

temp_study_4 <- data_reshaped_intentions_moderation_by_extinction_oec %>%
  filter(experiment == 4) %>%
  select(brand_A, brand_B) %>%
  as.matrix() %>%
  epitools::epitab(x = .)

temp_study_7 <- data_reshaped_intentions_moderation_by_extinction_oec %>%
  filter(experiment == 7) %>%
  select(brand_A, brand_B) %>%
  as.matrix() %>%
  epitools::epitab(x = .)

results_moderation_by_extinction_intentions_oec <-
  bind_rows(
    as.data.frame(temp_study_1$tab) %>%
      drop_na() %>%
      select(OR = oddsratio, OR_ci_lower = lower, OR_ci_upper = upper, p = p.value) %>%
...
write_csv(results_moderation_by_extinction_intentions_oec, "results/results_moderation_by_extinction_intentions_oec.csv")
...
## Were evaluative learning effects moderated by counterconditioning?
...
data_reshaped_intentions_moderation_by_counterconditioning_oec <- data_processed_after_exclusions %>%
  filter(experiment_condition %in% c("acquisition_only", "acquisition_and_counterconditioning") &
           experiment %in% c(5, 6, 7) &
           behavioral_intentions_OEC %in% c("brand_A", "brand_B")) %>%
  count(experiment, experiment_condition, behavioral_intentions_OEC) %>%
...
temp_study_5 <- data_reshaped_intentions_moderation_by_counterconditioning_oec %>%
  filter(experiment == 5) %>%
  select(brand_A, brand_B) %>%
  as.matrix() %>%
  epitools::epitab(x = .)

temp_study_6 <- data_reshaped_intentions_moderation_by_counterconditioning_oec %>%
  filter(experiment == 6) %>%
  select(brand_A, brand_B) %>%
  as.matrix() %>%
  epitools::epitab(x = .)

temp_study_7 <- data_reshaped_intentions_moderation_by_counterconditioning_oec %>%
  filter(experiment == 7) %>%
  select(brand_A, brand_B) %>%
  as.matrix() %>%
  epitools::epitab(x = .)

results_moderation_by_counterconditioning_intentions_oec <-
  bind_rows(
    as.data.frame(temp_study_5$tab) %>%
      drop_na() %>%
      select(OR = oddsratio, OR_ci_lower = lower, OR_ci_upper = upper, p = p.value) %>%
...
write_csv(results_moderation_by_counterconditioning_intentions_oec,
          "results/results_moderation_by_counterconditioning_intentions_oec.csv")
...
data_reshaped_ir_intentions_differences_between_ext_and_cc <- data_processed_after_exclusions %>%
  filter(experiment_condition %in% c("acquisition_and_extinction", "acquisition_and_counterconditioning") &
           experiment %in% c(7) &
           behavioral_intentions_IR %in% c("brand_A", "brand_B")) %>%
  count(experiment, experiment_condition, behavioral_intentions_IR) %>%
...
temp_study_7 <- data_reshaped_ir_intentions_differences_between_ext_and_cc %>%
  filter(experiment == 7) %>%
  select(brand_A, brand_B) %>%
  as.matrix() %>%
  epitools::epitab(x = .)

results_exp7_extinction_vs_counterconditioning_ir_intentions <-
  as.data.frame(temp_study_7$tab) %>%
  drop_na() %>%
  select(OR = oddsratio, OR_ci_lower = lower, OR_ci_upper = upper, p = p.value) %>%
  mutate(experiment = 7) %>%
...
write_csv(results_exp7_extinction_vs_counterconditioning_ir_intentions,
          "results/results_exp7_extinction_vs_counterconditioning_ir_intentions.csv")
...
data_reshaped_oec_intentions_differences_between_ext_and_cc <- data_processed_after_exclusions %>%
  filter(experiment_condition %in% c("acquisition_and_extinction", "acquisition_and_counterconditioning") &
           experiment %in% c(7) &
           behavioral_intentions_OEC %in% c("brand_A", "brand_B")) %>%
  count(experiment, experiment_condition, behavioral_intentions_OEC) %>%
...
temp_study_7 <- data_reshaped_oec_intentions_differences_between_ext_and_cc %>%
  filter(experiment == 7) %>%
  select(brand_A, brand_B) %>%
  as.matrix() %>%
  epitools::epitab(x = .)

results_exp7_extinction_vs_counterconditioning_oec_intentions <-
  as.data.frame(temp_study_7$tab) %>%
  drop_na() %>%
  select(OR = oddsratio, OR_ci_lower = lower, OR_ci_upper = upper, p = p.value) %>%
  mutate(experiment = 7) %>%
...
write_csv(results_exp7_extinction_vs_counterconditioning_oec_intentions,
          "results/results_exp7_extinction_vs_counterconditioning_oec_intentions.csv")
...
results_for_meta_basic_IR_effect_iat_selfreports <- results_basic_effect_iat_selfreports %>%
  rename(yi = cohens_d) %>%
...
results_for_meta_basic_effect_intentions_ir <- data_reshaped_intentions_acquisition_ir %>%
  ...
  escalc(measure = "OR",
         ...
         data = .) %>%
  mutate(sei = sqrt(logOR_to_d(vi)),
         yi = logOR_to_d(yi),
         DV_type = "Intentions") %>%
  select(experiment, DV_type, yi, sei)

fit_basic_effect_ir <- 
  bind_rows(results_for_meta_basic_IR_effect_iat_selfreports,
...
meta p value: `r fit_basic_effect_ir$pval`

## Basic OEC effect

```{r fig.height=6.5, fig.width=8}

results_for_meta_basic_OEC_effect_iat_selfreports <- results_basic_effect_iat_selfreports %>%
  rename(yi = cohens_d) %>%
  mutate(sei = (cohens_d_ci_upper - cohens_d_ci_lower)/(2*1.96)) %>%
  select(experiment, DV_type, yi, sei) %>%
  filter(DV_type %in% c("IAT_D2", "self_reported_OEC_effect"))

results_for_meta_basic_effect_intentions_oec <- data_reshaped_intentions_acquisition_oec %>%
  pivot_wider(names_from = stimulus_identity_condition,
              values_from = c(brand_A, brand_B)) %>%
  escalc(measure = "OR",
         ai = brand_A_Outcome_1_Target_1_Good_Outcome_2_Target_2_Bad,
...
fit_basic_effect_oec <- 
  bind_rows(results_for_meta_basic_OEC_effect_iat_selfreports,
            results_for_meta_basic_effect_intentions_oec) %>%
  mutate(DV_type = dplyr::recode(DV_type,
                                 "IAT_D2" = "IAT",
                                 "self_reported_OEC_effect" = "Self-report",
                                 "Intentions" = "Intentions")) %>%
  arrange(experiment, DV_type) %>%
  rma.mv(yi      = yi,
         V       = sei^2,
...
forest(fit_basic_effect_oec, 
       xlab = substitute(paste("Cohen's ", italic('d'))),
       addcred = TRUE,
       refline = 0,
       xlim = c(-2.5, 6),
       at = c(-1, 0, 1, 2, 3, 4, 5))
text(-2.5, 23, "Basic OEC effect", pos = 4)
text(6, 23, substitute(paste(italic('d'), " [95% CI]")), pos = 2)
...
meta p value: `r fit_basic_effect_oec$pval`
...
results_for_meta_extinction_ir <- results_moderation_by_extinction %>%
  rename(yi = cohens_d) %>%
  mutate(sei = (cohens_d_ci_upper - cohens_d_ci_lower)/(2*1.96)) %>%
  select(experiment, DV_type, yi, sei) %>%
...
fit_moderation_by_extinction_ir <- 
  bind_rows(results_for_meta_extinction_ir,
...
text(-2.5, 17, "Moderation of IR effect by extinction", pos = 4)
text(2, 17, substitute(paste(italic('d'), " [95% CI]")), pos = 2)

# save model fits for making pdf plots for publication
write_rds(fit_moderation_by_extinction_ir, "models/fit_moderation_by_extinction_ir.rds")
read_rds("models/fit_moderation_by_extinction_ir.rds")

```

meta p value: `r fit_moderation_by_extinction_ir$pval`
...
results_for_meta_extinction_oec <- results_moderation_by_extinction %>%
  rename(yi = cohens_d) %>%
  mutate(sei = (cohens_d_ci_upper - cohens_d_ci_lower)/(2*1.96)) %>%
  select(experiment, DV_type, yi, sei) %>%
  filter(DV_type %in% c("self_reported_OEC_effect_controlling_stimulus_identity"))

results_for_meta_moderation_extinction_intentions_oec <- data_reshaped_intentions_moderation_by_extinction_oec %>%
  pivot_wider(names_from = experiment_condition,
              values_from = c(brand_A, brand_B)) %>%
  escalc(measure = "OR",
         ai = brand_A_acquisition_only,
...
fit_moderation_by_extinction_oec <- 
  bind_rows(results_for_meta_extinction_oec,
            results_for_meta_moderation_extinction_intentions_oec) %>%
  mutate(DV_type = dplyr::recode(DV_type,
                                 "self_reported_OEC_effect_controlling_stimulus_identity" = "Self-report",
                                 "Intentions" = "Intentions")) %>%
  arrange(experiment, DV_type) %>%
  rma.mv(yi      = yi,
         V       = sei^2,
...
forest(fit_moderation_by_extinction_oec, 
       xlab = substitute(paste("Cohen's ", italic('d'))),
       addcred = TRUE,
       refline = 0,
       xlim = c(-2.5, 3),
       at = c(-1.5, -1, -0.5, 0, 0.5, 1, 1.5))
text(-2.5, 12, "Moderation of OEC effect by extinction", pos = 4)
text(3, 12, substitute(paste(italic('d'), " [95% CI]")), pos = 2)

# save model fits for making pdf plots for publication
write_rds(fit_moderation_by_extinction_oec, "models/fit_moderation_by_extinction_oec.rds")
read_rds("models/fit_moderation_by_extinction_oec.rds")

```

meta p value: `r fit_moderation_by_extinction_oec$pval`
...
results_for_meta_counterconditioning_ir <- results_moderation_by_counterconditioning %>%
  rename(yi = cohens_d) %>%
  mutate(sei = (cohens_d_ci_upper - cohens_d_ci_lower)/(2*1.96)) %>%
  select(experiment, DV_type, yi, sei) %>%
  filter(DV_type %in% c("IAT_D2_controlling_stimulus_identity", "self_reported_IR_effect_controlling_stimulus_identity"))
...
fit_moderation_by_counterconditioning_ir <- 
  bind_rows(results_for_meta_counterconditioning_ir,
...
# save model fits for making pdf plots for publication
write_rds(fit_moderation_by_counterconditioning_ir, "models/fit_moderation_by_counterconditioning_ir.rds")
read_rds("models/fit_moderation_by_counterconditioning_ir.rds")
```

meta p value: `r fit_moderation_by_counterconditioning_ir$pval`
...
results_for_meta_counterconditioning_oec <- results_moderation_by_counterconditioning %>%
  rename(yi = cohens_d) %>%
  mutate(sei = (cohens_d_ci_upper - cohens_d_ci_lower)/(2*1.96)) %>%
  select(experiment, DV_type, yi, sei) %>%
  filter(DV_type %in% c("self_reported_OEC_effect_controlling_stimulus_identity"))

results_for_meta_moderation_counterconditioning_intentions_oec <- data_reshaped_intentions_moderation_by_counterconditioning_oec %>%
  pivot_wider(names_from = experiment_condition,
              values_from = c(brand_A, brand_B)) %>%
  escalc(measure = "OR",
         ai = brand_A_acquisition_only,
...
fit_moderation_by_counterconditioning_oec <- 
  bind_rows(results_for_meta_counterconditioning_oec,
            results_for_meta_moderation_counterconditioning_intentions_oec) %>%
  mutate(DV_type = dplyr::recode(DV_type,
                                 "self_reported_OEC_effect_controlling_stimulus_identity" = "Self-report",
                                 "Intentions" = "Intentions")) %>%
  arrange(experiment, DV_type) %>%
...
forest(fit_moderation_by_counterconditioning_oec, 
       xlab = substitute(paste("Cohen's ", italic('d'))),
       addcred = TRUE,
       refline = 0,
       xlim = c(-3, 3),
       at = c(-2, -1.5, -1, -0.5, 0, 0.5, 1, 1.5))
text(-3, 8, "Moderation of OEC effect by counterconditioning", pos = 4)
text(3, 8, substitute(paste(italic('d'), " [95% CI]")), pos = 2)

# save model fits for making pdf plots for publication
write_rds(fit_moderation_by_counterconditioning_oec, "models/fit_moderation_by_counterconditioning_oec.rds")

```

meta p value: `r fit_moderation_by_counterconditioning_oec$pval`
...
results_for_meta_basic_effect_iat_selfreports_ir_sensitivity <- data_processed_after_exclusions_sensitivity %>%
  filter(experiment_condition == "acquisition_only") %>%
  rename(IV = stimulus_identity_condition) %>%
  gather(DV_type, DV, c(self_reported_IR_effect, IAT_D2)) %>%
  select(experiment, DV_type, DV, IV) %>%
  drop_na() %>%
  analysis_workflow(data = .) %>%
  rename(yi = cohens_d) %>%
...
fit_basic_effect_ir_sensitivity <- 
  bind_rows(results_for_meta_basic_effect_iat_selfreports_ir_sensitivity,
...
forest(fit_basic_effect_ir_sensitivity, 
       xlab = substitute(paste("Cohen's ", italic('d'))),
       addcred = TRUE,
       refline = 0,
       xlim = c(-2.5, 6),
       at = c(-1, 0, 1, 2, 3, 4, 5))
text(-2.5, 23, "Basic IR effect (Pass Group)", pos = 4)
text(6, 23, substitute(paste(italic('d'), " [95% CI]")), pos = 2)

# save model fits for making pdf plots for publication
write_rds(fit_basic_effect_ir_sensitivity, "models/fit_basic_effect_ir_sensitivity.rds")
read_rds("models/fit_basic_effect_ir_sensitivity.rds")



congruence_with_full_sample_ir <- 
  ifelse((fit_basic_effect_ir$ci.lb > 0 & fit_basic_effect_ir_sensitivity$ci.lb > 0) |
           (fit_basic_effect_ir$ci.ub < 0 & fit_basic_effect_ir_sensitivity$ci.ub < 0) |
           (fit_basic_effect_ir$ci.lb < 0 & fit_basic_effect_ir_sensitivity$ci.lb < 0 & 
              fit_basic_effect_ir$ci.ub > 0 & fit_basic_effect_ir_sensitivity$ci.ub > 0),
...
`r congruence_with_full_sample_ir`
...
results_for_meta_basic_effect_iat_selfreports_oec_sensitivity <- data_processed_after_exclusions_sensitivity %>%
  filter(experiment_condition == "acquisition_only") %>%
  rename(IV = stimulus_identity_condition) %>%
  gather(DV_type, DV, c(self_reported_OEC_effect)) %>%
  select(experiment, DV_type, DV, IV) %>%
  drop_na() %>%
  analysis_workflow(data = .) %>%
  rename(yi = cohens_d) %>%
  mutate(sei = (cohens_d_ci_upper - cohens_d_ci_lower)/(2*1.96)) %>%
  select(experiment, DV_type, yi, sei) %>%
  filter(DV_type %in% c("self_reported_OEC_effect"))

results_basic_effect_intentions_oec_sensitivity <- data_processed_after_exclusions_sensitivity %>%
  filter(experiment_condition == c("acquisition_only") &
           behavioral_intentions_OEC %in% c("brand_A", "brand_B")) %>%
  count(experiment, stimulus_identity_condition, behavioral_intentions_OEC) %>%
  spread(behavioral_intentions_OEC, n) %>%
...
fit_basic_effect_oec_sensitivity <- 
  bind_rows(results_for_meta_basic_effect_iat_selfreports_oec_sensitivity,
            results_basic_effect_intentions_oec_sensitivity) %>%
  mutate(DV_type = dplyr::recode(DV_type,
                                 "self_reported_OEC_effect" = "Self-report",
                                 "Intentions" = "Intentions")) %>%
  arrange(experiment, DV_type) %>%
...
forest(fit_basic_effect_oec_sensitivity, 
       xlab = substitute(paste("Cohen's ", italic('d'))),
       addcred = TRUE,
       refline = 0,
       xlim = c(-2.5, 7),
       at = c(-1, 0, 1, 2, 3, 4, 5))
text(-2.5, 16, "Basic OEC effect (Pass Group)", pos = 4)
text(6, 16, substitute(paste(italic('d'), " [95% CI]")), pos = 2)

# save model fits for making pdf plots for publication
write_rds(fit_basic_effect_oec_sensitivity, "models/fit_basic_effect_oec_sensitivity.rds")

congruence_with_full_sample_oec <- 
  ifelse((fit_basic_effect_oec$ci.lb > 0 & fit_basic_effect_oec_sensitivity$ci.lb > 0) |
           (fit_basic_effect_oec$ci.ub < 0 & fit_basic_effect_oec_sensitivity$ci.ub < 0) |
           (fit_basic_effect_oec$ci.lb < 0 & fit_basic_effect_oec_sensitivity$ci.lb < 0 & 
              fit_basic_effect_oec$ci.ub > 0 & fit_basic_effect_oec_sensitivity$ci.ub > 0),
         "Conclusions about the signficance of the estimate of the effect were congruent between the meta-analysis and sensitivity analysis.", "Conclusions about the signficance of the estimate of the effect were incongruent between the meta-analysis and sensitivity analysis.")
...
`r congruence_with_full_sample_oec`
...
results_for_meta_extinction_ir_sensitivity <- data_processed_after_exclusions_sensitivity %>%
  filter(experiment_condition %in% c("acquisition_only", "acquisition_and_extinction") &
           experiment %in% c(1, 2, 3, 4, 7)) %>%
  rename(IV = experiment_condition) %>%
  mutate(IV = fct_relevel(IV, "acquisition_and_extinction", "acquisition_only")) %>%
  gather(DV_type, DV, c(self_reported_IR_effect_controlling_stimulus_identity,
                        IAT_D2_controlling_stimulus_identity)) %>%
  select(experiment, DV_type, DV, IV) %>%
  drop_na() %>%
  analysis_workflow(data = .) %>%
...
fit_moderation_by_extinction_ir_sensitivity <- 
  bind_rows(results_for_meta_extinction_ir_sensitivity,
...
forest(fit_moderation_by_extinction_ir_sensitivity, 
       xlab = substitute(paste("Cohen's ", italic('d'))),
       addcred = TRUE,
       refline = 0,
       xlim = c(-3.5, 3.5),
       at = c(-2, -1, 0, 1, 2))
text(-3.5, 17, "Moderation of IR effect by extinction (Pass Group)", pos = 4)
text(3.5, 17, substitute(paste(italic('d'), " [95% CI]")), pos = 2)

# save model fits for making pdf plots for publication
write_rds(fit_moderation_by_extinction_ir_sensitivity, "models/fit_moderation_by_extinction_ir_sensitivity.rds")

congruence_with_full_sample_extinction_ir <- 
  ifelse((fit_moderation_by_extinction_ir$ci.lb > 0 & fit_moderation_by_extinction_ir_sensitivity$ci.lb > 0) |
           (fit_moderation_by_extinction_ir$ci.ub < 0 & fit_moderation_by_extinction_ir_sensitivity$ci.ub < 0) |
           (fit_moderation_by_extinction_ir$ci.lb < 0 & fit_moderation_by_extinction_ir_sensitivity$ci.lb < 0 & 
              fit_moderation_by_extinction_ir$ci.ub > 0 & fit_moderation_by_extinction_ir_sensitivity$ci.ub > 0),
         "Conclusions about the signficance of the estimate of the effect were congruent between the meta-analysis and sensitivity analysis.", "Conclusions about the signficance of the estimate of the effect were incongruent between the meta-analysis and sensitivity analysis.")
...
`r congruence_with_full_sample_extinction_ir`
...
results_for_meta_extinction_oec_sensitivity <- data_processed_after_exclusions_sensitivity %>%
  filter(experiment_condition %in% c("acquisition_only", "acquisition_and_extinction") &
           experiment %in% c(1, 2, 3, 4, 7)) %>%
  rename(IV = experiment_condition) %>%
  mutate(IV = fct_relevel(IV, "acquisition_and_extinction", "acquisition_only")) %>%
...
results_moderation_extinction_intentions_oec_sensitivity <- data_processed_after_exclusions_sensitivity %>%
  filter(experiment_condition %in% c("acquisition_only", "acquisition_and_extinction") &
           experiment %in% c(1, 2, 3, 4, 7) &
           behavioral_intentions_OEC %in% c("brand_A", "brand_B")) %>%
  count(experiment, experiment_condition, behavioral_intentions_OEC) %>%
...
fit_moderation_by_extinction_oec_sensitivity <- 
  bind_rows(results_for_meta_extinction_oec_sensitivity,
            results_moderation_extinction_intentions_oec_sensitivity) %>%
  mutate(DV_type = dplyr::recode(DV_type,
                                 "self_reported_OEC_effect_controlling_stimulus_identity" = "Self-report",
                                 "Intentions" = "Intentions")) %>%
  arrange(experiment, DV_type) %>%
...
forest(fit_moderation_by_extinction_oec_sensitivity, 
       xlab = substitute(paste("Cohen's ", italic('d'))),
       addcred = TRUE,
       refline = 0,
       xlim = c(-3.5, 3.5),
       at = c(-2, -1, 0, 1, 2))
text(-3.5, 12, "Moderation of OEC effect by extinction (Pass Group)", pos = 4)
text(3.5, 12, substitute(paste(italic('d'), " [95% CI]")), pos = 2)

# save model fits for making pdf plots for publication
write_rds(fit_moderation_by_extinction_oec_sensitivity, "models/fit_moderation_by_extinction_oec_sensitivity.rds")

congruence_with_full_sample_extinction_oec <- 
  ifelse((fit_moderation_by_extinction_oec$ci.lb > 0 & fit_moderation_by_extinction_oec_sensitivity$ci.lb > 0) |
           (fit_moderation_by_extinction_oec$ci.ub < 0 & fit_moderation_by_extinction_oec_sensitivity$ci.ub < 0) |
           (fit_moderation_by_extinction_oec$ci.lb < 0 & fit_moderation_by_extinction_oec_sensitivity$ci.lb < 0 & 
              fit_moderation_by_extinction_oec$ci.ub > 0 & fit_moderation_by_extinction_oec_sensitivity$ci.ub > 0),
         "Conclusions about the signficance of the estimate of the effect were congruent between the meta-analysis and sensitivity analysis.", "Conclusions about the signficance of the estimate of the effect were incongruent between the meta-analysis and sensitivity analysis.")
...
`r congruence_with_full_sample_extinction_oec`
...
results_for_meta_counterconditioning_ir_sensitivity <- data_processed_after_exclusions_sensitivity %>%
  filter(experiment_condition %in% c("acquisition_only", "acquisition_and_counterconditioning") &
           experiment %in% c(5, 6, 7)) %>%
  rename(IV = experiment_condition) %>%
  mutate(IV = fct_relevel(IV, "acquisition_and_counterconditioning", "acquisition_only")) %>%
...
fit_moderation_by_counterconditioning_ir_sensitivity <- 
  bind_rows(results_for_meta_counterconditioning_ir_sensitivity,
            results_moderation_extinction_intentions_ir_sensitivity) %>%
  mutate(DV_type = dplyr::recode(DV_type,
                                 "IAT_D2_controlling_stimulus_identity" = "IAT",
                                 "self_reported_IR_effect_controlling_stimulus_identity" = "Self-report",
...
forest(fit_moderation_by_counterconditioning_ir_sensitivity, 
       xlab = substitute(paste("Cohen's ", italic('d'))),
       addcred = TRUE,
       refline = 0,
       xlim = c(-3.5, 3.5),
       at = c(-2, -1, 0, 1, 2))
text(-3.5, 11, "Moderation of IR effect by counterconditioning (Pass Group)", pos = 4)
text(3.5, 11, substitute(paste(italic('d'), " [95% CI]")), pos = 2)

# save model fits for making pdf plots for publication
write_rds(fit_moderation_by_counterconditioning_ir_sensitivity,
          "models/fit_moderation_by_counterconditioning_ir_sensitivity.rds")

congruence_with_full_sample_counterconditioning_ir <- 
  ifelse((fit_moderation_by_counterconditioning_ir$ci.lb > 0 & fit_moderation_by_counterconditioning_ir_sensitivity$ci.lb > 0) |
           (fit_moderation_by_counterconditioning_ir$ci.ub < 0 & fit_moderation_by_counterconditioning_ir_sensitivity$ci.ub < 0) |
           (fit_moderation_by_counterconditioning_ir$ci.lb < 0 & fit_moderation_by_counterconditioning_ir_sensitivity$ci.lb < 0 & 
              fit_moderation_by_counterconditioning_ir$ci.ub > 0 & fit_moderation_by_counterconditioning_ir_sensitivity$ci.ub > 0),
         "Conclusions about the signficance of the estimate of the effect were congruent between the meta-analysis and sensitivity analysis.", "Conclusions about the signficance of the estimate of the effect were incongruent between the meta-analysis and sensitivity analysis.")
...
`r congruence_with_full_sample_counterconditioning_ir`
...
results_for_meta_counterconditioning_oec_sensitivity <- data_processed_after_exclusions_sensitivity %>%
  filter(experiment_condition %in% c("acquisition_only", "acquisition_and_counterconditioning") &
           experiment %in% c(5, 6, 7)) %>%
  rename(IV = experiment_condition) %>%
  mutate(IV = fct_relevel(IV, "acquisition_and_counterconditioning", "acquisition_only")) %>%
...
fit_moderation_by_counterconditioning_oec_sensitivity <- 
  bind_rows(results_for_meta_counterconditioning_oec_sensitivity,
            results_moderation_extinction_intentions_oec_sensitivity) %>%
  mutate(DV_type = dplyr::recode(DV_type,
                                 "self_reported_OEC_effect_controlling_stimulus_identity" = "Self-report",
                                 "Intentions" = "Intentions")) %>%
...
forest(fit_moderation_by_counterconditioning_oec_sensitivity, 
       xlab = substitute(paste("Cohen's ", italic('d'))),
       addcred = TRUE,
       refline = 0,
       xlim = c(-3.5, 3.5),
       at = c(-2.0, -1, 0, 1, 2))
text(-3.5, 8, "Moderation of OEC effect by counterconditioning (Pass Group)", pos = 4)
text(3.5, 8, substitute(paste(italic('d'), " [95% CI]")), pos = 2)

# save model fits for making pdf plots for publication
write_rds(fit_moderation_by_counterconditioning_oec_sensitivity,
          "models/fit_moderation_by_counterconditioning_oec_sensitivity.rds")

congruence_with_full_sample_counterconditioning_oec <- 
  ifelse((fit_moderation_by_counterconditioning_oec$ci.lb > 0 & fit_moderation_by_counterconditioning_oec_sensitivity$ci.lb > 0) |
           (fit_moderation_by_counterconditioning_oec$ci.ub < 0 & fit_moderation_by_counterconditioning_oec_sensitivity$ci.ub < 0) |
           (fit_moderation_by_counterconditioning_oec$ci.lb < 0 & fit_moderation_by_counterconditioning_oec_sensitivity$ci.lb < 0 & 
              fit_moderation_by_counterconditioning_oec$ci.ub > 0 & fit_moderation_by_counterconditioning_oec_sensitivity$ci.ub > 0),
         "Conclusions about the signficance of the estimate of the effect were congruent between the meta-analysis and sensitivity analysis.", "Conclusions about the signficance of the estimate of the effect were incongruent between the meta-analysis and sensitivity analysis.")
...
`r congruence_with_full_sample_counterconditioning_oec`
