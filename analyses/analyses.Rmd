...
fit_moderation_extinction_intentions_ir <- data_reshaped_intentions_moderation_by_extinction_ir %>%
...
fit_moderation_counterconditioning_intentions_ir <- data_reshaped_intentions_moderation_by_counterconditioning_ir %>%
  pivot_wider(names_from = experiment_condition,
              values_from = c(brand_A, brand_B)) %>%
  escalc(measure = "OR",
         ai = brand_A_acquisition_only,
...
fit_moderation_extinction_intentions_ir_sensitivity <- data_reshaped_intentions_moderation_by_extinction_ir_sensitivity %>%
  pivot_wider(names_from = experiment_condition,
              values_from = c(brand_A, brand_B)) %>%
  escalc(measure = "OR",
         ai = brand_A_acquisition_only,
...
fit_moderation_counterconditioning_intentions_ir_sensitivity <-
  data_reshaped_intentions_moderation_by_counterconditioning_ir_sensitivity %>%
  pivot_wider(names_from = experiment_condition,
              values_from = c(brand_A, brand_B)) %>%
  escalc(measure = "OR",
         ai = brand_A_acquisition_only,
