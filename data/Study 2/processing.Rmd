...
data_experiment_condition <- 
  bind_rows(
    # training
    read_xlsx("raw/extinction1b_intersecting_regularities_left.xlsx") %>% 
      mutate(response = as.character(response)),
    read_xlsx("raw/extinction1b_intersecting_regularities_left_rev.xlsx") %>% 
      mutate(response = as.character(response)),
    read_xlsx("raw/extinction1b_intersecting_regularities_right.xlsx") %>% 
      mutate(response = as.character(response)),
    read_xlsx("raw/extinction1b_intersecting_regularities_right_rev.xlsx") %>% 
      mutate(response = as.character(response)),
    # testing
    read_xlsx("raw/testing_left1b.xlsx") %>% 
      mutate(response = as.character(response)),
    read_xlsx("raw/testing_left1b_rev.xlsx") %>% 
      mutate(response = as.character(response)),
    read_xlsx("raw/testing_right1b.xlsx") %>% 
      mutate(response = as.character(response)),
    read_xlsx("raw/testing_right1b_rev.xlsx") %>% 
      mutate(response = as.character(response))
  ) %>%
