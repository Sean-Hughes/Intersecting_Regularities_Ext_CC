...
data_experiment_condition <- 
  bind_rows(
    read_xlsx("raw/counterconditioning1b_intersecting_regularities_left.xlsx") %>% 
      mutate(response = as.character(response)),
    read_xlsx("raw/counterconditioning1b_intersecting_regularities_left_rev.xlsx") %>% 
      mutate(response = as.character(response)),
    read_xlsx("raw/counterconditioning1b_intersecting_regularities_right.xlsx") %>% 
      mutate(response = as.character(response)),
    read_xlsx("raw/counterconditioning1b_intersecting_regularities_right_rev.xlsx") %>% 
      mutate(response = as.character(response))
  ) %>%
