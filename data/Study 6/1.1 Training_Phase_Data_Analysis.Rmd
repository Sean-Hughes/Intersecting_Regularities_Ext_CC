---
title: "Study 6: Acquisition Phase Data"
author: "Sean Hughes"
date: "30-5-2020"
output: 
  html_document:
...
raw_data_1 <- read_xlsx(paste0(wd$data, "intersecting_regularities_left_17_04_26.xlsx"), col_names = TRUE)
raw_data_2 <- read_xlsx(paste0(wd$data, "intersecting_regularities_left_rev_17_04_26.xlsx"), col_names = TRUE)
raw_data_3 <- read_xlsx(paste0(wd$data, "intersecting_regularities_right_17_04_26.xlsx"), col_names = TRUE)
raw_data_4 <- read_xlsx(paste0(wd$data, "intersecting_regularities_right_rev_17_04_26.xlsx"), col_names = TRUE)
...
write_csv2(summarised_data, path = paste0(wd$output, "Study_6_Training_Phase.csv"))
write_csv2(stimulus_identity, path = paste0(wd$output, "Study_6_Stimulus_Identity.csv"))
