...
- add other conditions to selfreports, iat
...
- WHERE IS EXTINCTION IN THE PLOT/DATA???
...
data_demand <- read_xlsx("raw/acquisition_only/demand.xlsx") %>% 
...
data_reactance <- read_xlsx("raw/acquisition_only/reactance.xlsx") %>% 
  select(subject, 
...
data_confidence_ratings <- read_xlsx("raw/acquisition_only/confidence_ratings.xlsx") %>% 
  select(subject, 
...
data_ratings <- read_xlsx("raw/acquisition_only/valence_ratings.xlsx") %>% 
  select(subject, 
