...
data_training_and_testing_performance_temp <- data_training_and_testing_input %>%
  ...
  filter(!str_detect(phase, "extinction")) %>%
  ...
  mutate(phase = fct_relevel(phase,
                             # "extinction_testing", # not in this study
                             # "extinction_training",
                             "acqusitiion_testing",
...
data_processed <- data_conditions %>%
  ...
  select(experiment, 
         ...
         completeness_extinction_training, #completeness_extinction_testing, # not in this study
         complete_iat_data, 
         ...
         #mean_correct_extinction_training, mean_correct_extinction_testing, # not in this study
         ...
         #passed_performance_criterion_extinction_training, passed_performance_criterion_extinction_testing, # not in this study
