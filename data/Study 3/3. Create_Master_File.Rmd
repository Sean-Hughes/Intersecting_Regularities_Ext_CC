...
wd <- list()
wd$data   <- "C:/Users/Sean/Desktop/Intersecting_Regularties_/Study 3/Raw_Data/"
wd$output <- "C:/Users/Sean/Desktop/Intersecting_Regularties_/Study 3/Processed_Data/"

data_belief_cover_story    <- read_xlsx(paste0(wd$data, "cover_belief_17_03_28.xlsx"), col_names = TRUE)
data_confidence_ratings    <- read_xlsx(paste0(wd$data, "confidence_ratings_17_03_28.xlsx"), col_names = TRUE)   
data_demand                <- read_xlsx(paste0(wd$data, "demand_17_03_28.xlsx"), col_names = TRUE)
data_demographics          <- read_xlsx(paste0(wd$data, "demographics_17_03_28.xlsx"), col_names = TRUE)
data_exploratory_questions <- read_xlsx(paste0(wd$data,"exploratory_questions_17_03_28.xlsx"), col_names = TRUE)
data_intentions_1          <- read_xlsx(paste0(wd$data, "intention_ratings_1_3_17_03_28.xlsx"), col_names = TRUE)
data_intentions_2          <- read_xlsx(paste0(wd$data, "intention_ratings_2_4_17_03_28.xlsx"), col_names = TRUE)
data_reactance             <- read_xlsx(paste0(wd$data, "reactance_17_03_28.xlsx"), col_names = TRUE)
data_ratings               <- read_xlsx(paste0(wd$data, "valence_ratings_17_03_28.xlsx"), col_names = TRUE)
data_task_order_1          <- read_xlsx(paste0(wd$data, "stimulus_ratings_before_17_03_28.xlsx"), col_names = TRUE)   
data_task_order_2          <- read_xlsx(paste0(wd$data, "stimulus_ratings_after_17_03_28.xlsx"), col_names = TRUE)   
data_stimulus_identity     <- read_csv2(paste0(wd$output, "Study_3_Stimulus_Identity.csv"), col_names = TRUE)
data_training_condition    <- read_csv2(paste0(wd$output,"Study_3_Complete_Training_Testing_Data.csv"), col_names = TRUE)
data_iat                   <- read_csv2(paste0(wd$output,"Study_3_IAT_Scores.csv"), col_names = TRUE) 
...
Study_3_data <- Cleaned_demographics %>% 
...
Study_3_data[duplicated(Study_3_data$subject), ]
Study_3_data <- Study_3_data[!duplicated(Study_3_data$subject), ]

# Drop participants who have incomplete data

Study_3_data <- Study_3_data %>% 
...
write_csv2(Study_3_data, path = paste0(wd$output, "Study_3_Master_File.csv"))
