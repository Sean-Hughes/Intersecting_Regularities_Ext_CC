---
title: "Study 3: Acquisition Phase Data"
author: "Sean Hughes"
date: "30-5-2020"
output: 
  html_document:
...
raw_data_1 <- read_xlsx(paste0(wd$data, "intersecting_regularities_left_17_03_28.xlsx"), col_names = TRUE)
raw_data_2 <- read_xlsx(paste0(wd$data, "intersecting_regularities_left_rev_17_03_28.xlsx"), col_names = TRUE)
raw_data_3 <- read_xlsx(paste0(wd$data, "intersecting_regularities_right_17_03_28.xlsx"), col_names = TRUE)
raw_data_4 <- read_xlsx(paste0(wd$data, "intersecting_regularities_right_rev_17_03_28.xlsx"), col_names = TRUE)
...
write_csv2(summarised_data, path = paste0(wd$output, "Study_3_Training_Phase.csv"))
write_csv2(stimulus_identity, path = paste0(wd$output, "Study_3_Stimulus_Identity.csv"))
