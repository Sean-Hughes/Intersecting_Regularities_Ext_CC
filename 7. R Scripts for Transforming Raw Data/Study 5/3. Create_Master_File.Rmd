...
data_belief_cover_story    <- read_xlsx(paste0(wd$data, "cover_belief_17_04_14.xlsx"), col_names = TRUE)
data_confidence_ratings    <- read_xlsx(paste0(wd$data, "confidence_ratings_17_04_14.xlsx"), col_names = TRUE)   
data_demand                <- read_xlsx(paste0(wd$data, "demand_17_04_14.xlsx"), col_names = TRUE)
data_demographics          <- read_xlsx(paste0(wd$data, "demographics_17_04_14.xlsx"), col_names = TRUE)
data_exploratory_questions <- read_xlsx(paste0(wd$data, "exploratory_questions_17_04_14.xlsx"), col_names = TRUE)
data_intentions_1          <- read_xlsx(paste0(wd$data, "intention_ratings_1_3_17_04_14.xlsx"), col_names = TRUE)
data_intentions_2          <- read_xlsx(paste0(wd$data, "intention_ratings_2_4_17_04_14.xlsx"), col_names = TRUE)
data_reactance             <- read_xlsx(paste0(wd$data, "reactance_17_04_14.xlsx"), col_names = TRUE)
data_ratings               <- read_xlsx(paste0(wd$data, "valence_ratings_17_04_14.xlsx"), col_names = TRUE)
data_task_order_1          <- read_xlsx(paste0(wd$data, "stimulus_ratings_before_17_04_14.xlsx"), col_names = TRUE)   
data_task_order_2          <- read_xlsx(paste0(wd$data, "stimulus_ratings_after_17_04_14.xlsx"), col_names = TRUE)   
data_stimulus_identity     <- read_csv2(paste0(wd$output, "Study_5_Stimulus_Identity.csv"), col_names = TRUE)
data_training_condition    <- read_csv2(paste0(wd$output,"Study_5_Complete_Training_Testing_Data.csv"), col_names = TRUE)
data_iat                   <- read_csv2(paste0(wd$output,"Study_5_IAT_Scores.csv"), col_names = TRUE) 
...
Study_5_data <- Cleaned_demographics %>% 
...
Study_5_data[duplicated(Study_5_data$subject), ]
Study_5_data <- Study_5_data[!duplicated(Study_5_data$subject), ]

# Drop participants who have incomplete data

Study_5_data <- Study_5_data %>% 
...
write_csv2(Study_5_data, path = paste0(wd$output, "Study_5_Master_File.csv"))
