...
raw_data_1 <- read_csv2(paste0(wd$output, "Study_3_Training_Phase.csv"), col_names = TRUE)
raw_data_2 <- read_csv2(paste0(wd$output, "Study_3_Test_Phase_1.csv"), col_names = TRUE)
raw_data_3 <- read_csv2(paste0(wd$output, "Study_3_Extinction_Phase.csv"), col_names = TRUE)
raw_data_4 <- read_csv2(paste0(wd$output, "Study_3_Test_Phase_2.csv"), col_names = TRUE)
...
# 3. Extinction Phase
# 4. Extinction Phase Test (i.e., to see if people learned anything during the extinction phase)
...
write_csv2(as.data.frame(experimental_condition), path = paste0(wd$output, "Study_3_Complete_Training_Testing_Data.csv"))
