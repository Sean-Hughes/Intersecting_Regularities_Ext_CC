...
raw_IAT_data_1 <- read_xlsx(paste0(wd$data, "iat_symbols_before_17_03_28.xlsx"), col_names = TRUE)
raw_IAT_data_2 <- read_xlsx(paste0(wd$data, "iat_symbols_after_17_03_28.xlsx"), col_names = TRUE)
...
write_csv2(as.data.frame(data_IAT_D2_scores), path = paste0(wd$output, "Study_3_IAT_Scores.csv"))
