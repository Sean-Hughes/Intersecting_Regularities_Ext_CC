---
title: "Study 7: Testing Phase (after Acquisition Phase)"
author: "Sean Hughes"
date: "30-5-2020"
output: 
  html_document:
...
raw_data_AQ_1 <- read_xlsx(paste0(wd$data_AQ, "testing1_nokeylocation_17_06_20.xlsx"), col_names = TRUE)
raw_data_AQ_2 <- read_xlsx(paste0(wd$data_AQ, "testing2_nokeylocation_17_06_20.xlsx"), col_names = TRUE)

# Counterconditioning Group Data

raw_data_CC_1 <- read_xlsx(paste0(wd$data_CC, "testing1_nokeylocation_raw.xlsx"), col_names = TRUE)
raw_data_CC_2 <- read_xlsx(paste0(wd$data_CC, "testing2_nokeylocation_raw.xlsx"), col_names = TRUE)
  
# Extinction Group Data

raw_data_EX_1 <- read_xlsx(paste0(wd$data_EX, "testing1_nokeylocation_19_04_05.xlsx"), col_names = TRUE)
raw_data_EX_2 <- read_xlsx(paste0(wd$data_EX, "testing2_nokeylocation_19_04_05.xlsx"), col_names = TRUE)

```

## 2. Join the test files together
...
## 4. Calculating Mean and SD of Accuracy for the test block
...
## 6. Graph accuracy across blocks for those who passed vs. failed in the three experimental conditions
...
write_csv2(Pass_Fail_Group, path = paste0(wd$output, "Study_7_Test_Phase_1.csv"))
