---
title: "Study 4: Acquisition Phase Data"
author: "Sean Hughes"
date: "30-5-2020"
output: 
  html_document:
...
raw_data_1 <- read_xlsx(paste0(wd$data, "intersecting_regularities_left_17_04_13.xlsx"), col_names = TRUE)
raw_data_2 <- read_xlsx(paste0(wd$data, "intersecting_regularities_left_rev_17_04_13.xlsx"), col_names = TRUE)
raw_data_3 <- read_xlsx(paste0(wd$data, "intersecting_regularities_right_17_04_13.xlsx"), col_names = TRUE)
raw_data_4 <- read_xlsx(paste0(wd$data, "intersecting_regularities_right_rev_17_04_13.xlsx"), col_names = TRUE)
...
Study_4_pass_fail_group <- Pass_Group %>% 
  bind_rows(Fail_Group) %>% 
  arrange(subject)
...
write_csv2(summarised_data, path = paste0(wd$output, "Study_4_Training_Phase.csv"))
write_csv2(stimulus_identity, path = paste0(wd$output, "Study_4_Stimulus_Identity.csv"))
