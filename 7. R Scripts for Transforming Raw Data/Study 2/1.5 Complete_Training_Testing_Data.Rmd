...
raw_data_1 <- read_csv2(paste0(wd$output, "Study_2_Training_Phase.csv"), col_names = TRUE)
raw_data_2 <- read_csv2(paste0(wd$output, "Study_2_Test_Phase_1.csv"), col_names = TRUE)
raw_data_3 <- read_csv2(paste0(wd$output, "Study_2_Extinction_Phase.csv"), col_names = TRUE)
raw_data_4 <- read_csv2(paste0(wd$output, "Study_2_Test_Phase_2.csv"), col_names = TRUE)
...
write_csv2(as.data.frame(experimental_condition), path = paste0(wd$output, "Study_2_Complete_Training_Testing_Data.csv"))
